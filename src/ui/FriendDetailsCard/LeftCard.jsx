...
const LeftCard = ({ friend }) => {
    // console.log(friend);
    return (
      <div className="px-5 md:px-10 lg:px-0  flex flex-col md:flex-row lg:flex-col gap-6 justify-start md:justify-center lg:justify-start">
        <div className="border  border-[hsl(0,2%,94%)] shadow-md rounded-md  w-full max-w-[350px] py-6 px-12">
          ...
          <p className="mt-3 text-[#6474bb] text-center">
            Email: {friend.email}
          </p>
        </div>

        <div className="flex flex-col max-w-[350px] gap-2 mt-4">
          <button className="border  border-[hsl(0,2%,94%)] shadow-md rounded-md py-4 px-20 flex gap-2 justify-center items-center font-semibold">
