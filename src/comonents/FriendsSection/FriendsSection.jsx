...
const FriendsSection = () => {
  ...
  return (
    <div className="container mx-auto">
      ...
      <h2 className="px-5 lg:px-20 font-bold text-3xl mb-4">Your Friends</h2>
      ...
      {loading ? (
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10 pb-15 px-5 lg:px-20">
          {friends.map((friend) => (
